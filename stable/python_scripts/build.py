...
class WebGenerator:
    ...
    def get_header(self, current_page, current_coordinator=None):
        ...
        <body>
            <p class=banner>Nightly version updated every day available at <a href=https://crocs-muni.github.io/coinjoin/index.html>https://crocs-muni.github.io/coinjoin/index.html</a></p>
            <header>
